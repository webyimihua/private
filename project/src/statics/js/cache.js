...
layui.use(['form','jquery',"layer"],function() {
    ...
    function lockPage(){
        layer.open({
            ...
            content : '<div class="admin-header-lock" id="lock-box">'+
                            ...
                            '<div class="admin-header-lock-name" id="lockUserName">系统处于锁屏状态</div>'+
                            '<div class="input_btn">'+
    ...
    $("body").on("click","#unlock",function(){
        if($(this).siblings(".admin-header-lock-input").val() == ''){
            ...
            if($(this).siblings(".admin-header-lock-input").val() == sessionStorage.getItem('spPsw')){
    ...
    $(".functionSetting").click(function(){
        layer.open({
            ...
            area: ["580px", "400px"],
            type:2,
            content :'page/ocs.html',
        })
    })
    
    //app下载
    $(".functionLoad").click(function(){
        layer.open({
            title: "移动端APP下载",
            area: ["380px", "280px"],
            type: "1",
            content :  '<div class="functionSrtting_boxs">'+
                            '<div class="left_sm">目前支持安卓版本APP下载使用，请使用手机QQ扫码工具扫描右侧的二维码进行安装包下载，下载完成后直接安装即可</div>'+
                            '<div class="right_erweima">'+
                               '<img src="../images/load.png" alt="二维码下载"/>'+
                            '</div>'+
                        '</div>',
