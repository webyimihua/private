...
layui.use(['form','layer','table','laytpl','tools'],function(){
   ...
   var tableIns = table.render({
        ...
        cols : [[
            ...
            {field: 'name', title: '监测域类型名称', minWidth:280, align:"center"},
    ...
    function editItem(data){
        var index = layui.layer.open({
            ...
            success : function(layero, index){
                var body = layui.layer.getChildFrame('body', index);
                if(data){                   
                    body.find(".areaName").val(data.name);   
    ...
    table.on('tool(itemList)', function(obj){
        ...
        if(layEvent === 'edit'){ //编辑
            ...
            layer.confirm('确定删除此信息？',{icon:3, title:'提示信息'},function(index){
               deleterailwayAreaData(data)
            });
        }
    });
     
    function deleterailwayAreaData(data){
        var param ={};
