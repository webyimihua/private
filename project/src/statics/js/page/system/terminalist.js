	...
	var form = layui.form,
		...
		var tableIns = table.render({
	        ...
	        cols : [[
	            ...
	            {field: 'name', title: '终端类型名称', minWidth:280, align:"center"},
	            {field: 'channelNum', title: '通道数量', minWidth:280, align:"center"},
	...
	function editItem(data) {
		var index = layui.layer.open({
			...
			success: function(layero, index) {
				var body = layui.layer.getChildFrame('body', index);
				if(data) {
					body.find(".stationName").val(data.name); 
					body.find(".stationNames").val(data.channelNum); 
